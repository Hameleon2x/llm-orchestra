...
Срок удерживается и внутри оборота: остаток времени уходит исполнителю как потолок ожидания на этот вызов, поэтому повторы и переключения моделей не уводят прогон далеко за дедлайн. Уже идущий запрос по-прежнему ограничивает только `timeout`.
